...
<head>
	...
	<title>Pivotal tc Server &#8212; Standard Edition</title>
	<link type="text/css" rel="stylesheet" href="splash.css">
</head>

<body>
	<div id="container">
		<!-- This page was released with Pivotal tc Server Standard Edition 3.2.4.SR1 -->
		<!-- Header -->
		...
		<div id="content">
    		<div id="intro">
				<!--<h4>Pivotal</h4>-->
				<h2>Pivotal tc Server &#8212; Standard Edition</h2>
			...
			<div>
				...
				<ul>
					<li><a href="https://network.pivotal.io/products/pivotal-tcserver">Pivotal tc Server Product Details</a><br />The official home for Pivotal tc Server.</li>
		...
		<div class="clearfix"></div>
		<div id="versions">
			Pivotal tc Server Standard Edition<br/>
